...
export default function LoginPage() {
  ...
  const friendlyError = (msg: string) => {
    if (msg.toLowerCase().includes('invalid login credentials')) return 'Incorrect email or password. Please try again.'
      ...
      <div className="w-full max-w-sm z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <button type="button" className="text-sm font-medium text-primary hover:text-primaryHover">
              Forgot Password?
            </button>
          </div>
        ...
        <p className="mt-8 text-center text-slate-500">
          ...
          <Link href="/signup" className="font-semibold text-primary hover:text-primaryHover">
            Sign Up
          </Link>
        </p>
      </div>
